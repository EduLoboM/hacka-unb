	...
	return json({
		...
		officialAccounts: {
			decanatos: [
				...
				{ name: 'Decanato de Pós-Graduação (DPG UnB)', handle: '@unb_oficial', url: 'https://www.instagram.com/unb_oficial/' },
				{ name: 'Biblioteca Central (BCE UnB)', handle: '@unb_oficial', url: 'https://www.instagram.com/unb_oficial/' }
			],
			juniorEnterprises: [
				...
				{ name: 'Engrena AeroDesign (Aeroespacial FGA)', handle: '@engrena_aerodesign', url: 'https://www.instagram.com/engrena_aerodesign/' },
				{ name: 'Piratas do Asfalto Baja SAE (Automotiva & Mecânica FGA)', handle: '@piratasdoasfalto', url: 'https://www.instagram.com/piratasdoasfalto/' },
